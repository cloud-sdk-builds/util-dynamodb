...
[`@aws-sdk/util-dynamodb`](https://www.npmjs.com/package/@aws-sdk/util-dynamodb/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/util-dynamodb@3.256.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/util-dynamodb": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/util-dynamodb@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/util-dynamodb@3.256.0/index.min.mjs": "sha384-nG3oFxEFE3MjjjrFYGSigEVeVinrjqZSu2vv+0IcxuWOgpOs0uHN5Voz+4hZtM2W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/util-dynamodb/blob/refs/tags/3.256.0/LICENSE
```
